...
#gps-random-median-file="/Users/zw/code/C_and_C++_Projects/Learning_Unix_Network_Programming/K-NN/resources/gps-random-median.csv"
echo ${main}

#echo Linear:
#$main linear 5 8 16 0.7 0.3 ../features/_DSC0%s.jpg $gps-random-median-file
